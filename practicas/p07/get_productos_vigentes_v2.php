	...
	<script>
		function show() {
			...
			*/
			...
			var imagen = img.replace('http://localhost/xampp/htdocs/tecweb/practicas/p05/', '');
		...
		function send2form(_id, nombre, marca, modelo, precio, unidades, detalles, imagen) { //form) { 
			var urlForm = "http://localhost/xampp/htdocs/tecweb/practicas/p07/formulario_productos_v3.php";
			var propID = "id=" + _id;
		...
		<table class="table">
			...
			<tbody>
				...
				foreach ($data as $key => $value) {
					...
					echo '<td class="row-data"><img src=http://localhost/xampp/htdocs/tecweb/practicas/p05/' . $value['imagen'] . ' width="200px" height="200px" /></td>';
