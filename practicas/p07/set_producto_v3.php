...
/* MySQL Conexion*/
$link = mysqli_connect('localhost', 'root', 'andely200223', 'marketzone');
// Chequea coneccion
if ($link == false) {
...
if (mysqli_query($link, $sql)) {
    ...
    echo '<br><br><strong>IMAGEN: </strong><br> <img src=http://localhost/xampp/htdocs/tecweb/practicas/p07/set_producto_v3.php' . $imagen . ' width="200px" height="200px" />';
    echo '</p>';
} else {
